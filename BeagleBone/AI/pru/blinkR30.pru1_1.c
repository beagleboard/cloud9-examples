...
//			to ground.
//	Setup:	Load the BBAI-PRUOUT_PRU1_1.dtbo overlay
//	See:	1) cloud9/common/prugpio.h for which pins attach to pr1_pru1.
...
// You need to load the BBAI-PRUOUT_PRU1_1.dtbo overlay to use this example.
// BBAI-PRUOUT_PRU1_1.dtbo sets pinmux for all PRU1_1 pins to PRUOUT!
...
uboot_overlay_addr0=BBAI-PRUOUT_PRU1_1.dtbo
